...
# Add position relative to introduction if missing
if 'position: relative;' not in content.split('.introduction {')[1].split('}')[0]:
...
# update the mobile queries to use --intro-p for portraitArtifact
